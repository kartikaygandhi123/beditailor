...
$cmbPlazoSideZip = $conn->real_escape_string($_POST['cmbPlazoSideZip']);
$cmbPlazoSidePocket = $conn->real_escape_string($_POST['cmbPlazoSidePocket']);
$cmbPlazoBelt = $conn->real_escape_string($_POST['cmbPlazoBelt']);
...
cmbPlazoSideZip = '$cmbPlazoSideZip',
cmbPlazoSidePocket = '$cmbPlazoSidePocket',
cmbPlazoBelt = '$cmbPlazoBelt',
