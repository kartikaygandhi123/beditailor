                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtF1" id="txtShirtF1" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'F1'" placeholder="F1">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtF2" id="txtShirtF2" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'F2'" placeholder="F2">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtF3" id="txtShirtF3" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'F3'" placeholder="F3">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtB1" id="txtShirtB1" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'B1'" placeholder="B1">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtB2" id="txtShirtB2" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'B2'" placeholder="B2">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control valid" name="txtShirtB3" id="txtShirtB3" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'B3'" placeholder="B3">
                                    </div>
                                </div>
