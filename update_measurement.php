...
$txtShirtF1 = $conn->real_escape_string($_POST['txtShirtF1']);
$txtShirtF2 = $conn->real_escape_string($_POST['txtShirtF2']);
$txtShirtF3 = $conn->real_escape_string($_POST['txtShirtF3']);
$txtShirtB1 = $conn->real_escape_string($_POST['txtShirtB1']);
$txtShirtB2 = $conn->real_escape_string($_POST['txtShirtB2']);
$txtShirtB3 = $conn->real_escape_string($_POST['txtShirtB3']);
